...
wget https://github.com/kuzsczk/kdlahsdksahd/releases/download/V1/udp-zivpn-linux-arm64 -O /usr/local/bin/zivpn
...
wget https://raw.githubusercontent.com/kuzsczk/kdlahsdksahd/main/config.json -O /etc/zivpn/config.json
